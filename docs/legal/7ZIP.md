...
CHD Tool may use 7-Zip to open ZIP, RAR, and 7Z files.

7-Zip is made by Igor Pavlov. CHD Tool does not own or maintain
7-Zip.
...
CHD Tool does not modify 7-Zip files.
...
CHD Tool is not connected to Igor Pavlov or the 7-Zip project.
