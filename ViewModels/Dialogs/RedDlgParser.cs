...
{
    private static readonly TimeSpan RedumpDetailsRegexTimeout = TimeSpan.FromMilliseconds(250);
    ...
    private static string BuildTotalSize(IReadOnlyList<ParsedFile> files)
    {
        ...
        foreach (ParsedFile file in files)
        {
            ...
            totalBytes = totalBytes > long.MaxValue - file.SizeBytes
                ? long.MaxValue
