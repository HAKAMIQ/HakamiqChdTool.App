...
internal enum QueueOperationMode
{
    None = 0,
    Convert = 1,
    Extract = 2,
...
internal readonly record struct QueueOperationModeResolution(
    string RequestedAction,
    bool HasAnySupportedOperation,
    bool IsSupportedForSelectedMode,
    bool HasSingleSupportedOperation);

internal static class QueueOperationModeResolver
{
    ...
    public static QueueOperationModeResolution ResolveRequestedActionForMode(
        string? path,
        QueueOperationMode selectedMode)
    {
        ...
        return new QueueOperationModeResolution(
    ...
    public static bool IsWaitingRowRunnableForMode(QueueRowData row, QueueOperationMode selectedMode)
    {
        ...
        QueueOperationModeResolution resolution = ResolveRequestedActionForMode(operationPath, selectedMode);
